      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            _InfoRow(
              label: l10n.mealBudgetLabel,
              value: '${budget.toStringAsFixed(2)}${currencySymbol()}',
            ),
            const SizedBox(height: 8),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Icon(Icons.timer_outlined, size: 13, color: AppColors.textMuted(context)),
                    ...
                    const SizedBox(width: 8),
                    Icon(Icons.person_outline, size: 13, color: AppColors.textMuted(context)),
                    const SizedBox(width: 2),
                    Text(
