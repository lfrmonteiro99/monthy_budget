(function () {
  ...
  var translations = {
    pt: {
      ...
      timeline_subtitle: 'Um mês inteiro de controlo financeiro — dia a dia, funcionalidade a funcionalidade.',
      timeline_day1_title: 'Define o orçamento mensal',
      timeline_day1_desc: 'Categorias, montantes e rendimento — tudo planeado em 5 minutos.',
      timeline_day3_title: 'Lembrete: conta da luz amanhã',
      timeline_day3_desc: 'Paga a tempo, evita coima. As contas nunca mais passam despercebidas.',
      timeline_day8_title: 'Plano de refeições semanal pronto',
      timeline_day8_desc: '7 jantares planeados dentro do orçamento alimentar. Lista de compras gerada automaticamente.',
      timeline_day12_title: 'Alerta de ritmo: restaurantes a 70%',
      timeline_day12_desc: 'Com 18 dias pela frente, a Maria ajusta os gastos para não ultrapassar o limite.',
      timeline_day20_title: 'Compras inteligentes no supermercado',
      timeline_day20_desc: 'Compara preços com o mês passado. Poupa €12 ao trocar de marca.',
      timeline_day28_title: 'Deduções fiscais em dia',
      timeline_day28_desc: '€340 em despesas de saúde registadas para o IRS. Sem surpresas na declaração.',
      timeline_day30_title: 'Mês fechado: €180 poupados',
      timeline_day30_desc: '12 dias em streak de orçamento. O coach sugere reforçar o fundo de emergência.',
    },
    ...
    en: {
      ...
      timeline_subtitle: 'A full month of financial control — day by day, feature by feature.',
      timeline_day1_title: 'Sets her monthly budget',
      timeline_day1_desc: 'Categories, amounts, and income — everything planned in 5 minutes.',
      timeline_day3_title: 'Reminder: electricity bill due tomorrow',
      timeline_day3_desc: 'Pays on time, avoids late fee. Bills never slip through again.',
      timeline_day8_title: 'Weekly meal plan ready',
      timeline_day8_desc: '7 dinners planned within food budget. Shopping list auto-generated.',
      timeline_day12_title: 'Pace alert: dining out at 70%',
      timeline_day12_desc: 'With 18 days left, Maria adjusts spending to stay within budget.',
      timeline_day20_title: 'Smart grocery shopping',
      timeline_day20_desc: 'Compares prices to last month. Saves €12 by switching brands.',
      timeline_day28_title: 'Tax deductions up to date',
      timeline_day28_desc: '€340 in health expenses tracked for IRS. No surprises at tax time.',
      timeline_day30_title: 'Month closed: €180 saved',
      timeline_day30_desc: '12-day budget streak. Coach suggests boosting emergency fund.',
    },
    ...
    es: {
      ...
      timeline_subtitle: 'Un mes completo de control financiero — día a día, función a función.',
      timeline_day1_title: 'Define su presupuesto mensual',
      timeline_day1_desc: 'Categorías, importes e ingresos — todo planificado en 5 minutos.',
      timeline_day3_title: 'Recordatorio: factura de luz mañana',
      timeline_day3_desc: 'Paga a tiempo, evita recargos. Las facturas nunca más pasan desapercibidas.',
      timeline_day8_title: 'Plan de comidas semanal listo',
      timeline_day8_desc: '7 cenas planificadas dentro del presupuesto de alimentación. Lista de compras generada automáticamente.',
      timeline_day12_title: 'Alerta de ritmo: restaurantes al 70%',
      timeline_day12_desc: 'Con 18 días por delante, María ajusta los gastos para no superar el límite.',
      timeline_day20_title: 'Compras inteligentes en el supermercado',
      timeline_day20_desc: 'Compara precios con el mes anterior. Ahorra €12 cambiando de marca.',
      timeline_day28_title: 'Deducciones fiscales al día',
      timeline_day28_desc: '€340 en gastos de salud registrados para Hacienda. Sin sorpresas en la declaración.',
      timeline_day30_title: 'Mes cerrado: €180 ahorrados',
      timeline_day30_desc: '12 días de racha presupuestaria. El coach sugiere reforzar el fondo de emergencia.',
    },
    ...
    fr: {
      ...
      timeline_subtitle: 'Un mois complet de contrôle financier — jour après jour, fonctionnalité après fonctionnalité.',
      timeline_day1_title: 'Définit son budget mensuel',
      timeline_day1_desc: 'Catégories, montants et revenus — tout planifié en 5 minutes.',
      timeline_day3_title: 'Rappel : facture d\'électricité demain',
      timeline_day3_desc: 'Paie à temps, évite les pénalités. Les factures ne passent plus inaperçues.',
      timeline_day8_title: 'Plan de repas hebdomadaire prêt',
      timeline_day8_desc: '7 dîners planifiés dans le budget alimentaire. Liste de courses générée automatiquement.',
      timeline_day12_title: 'Alerte de rythme : restaurants à 70%',
      timeline_day12_desc: 'Avec 18 jours restants, Maria ajuste ses dépenses pour rester dans le budget.',
      timeline_day20_title: 'Courses intelligentes au supermarché',
      timeline_day20_desc: 'Compare les prix avec le mois dernier. Économise 12€ en changeant de marque.',
      timeline_day28_title: 'Déductions fiscales à jour',
      timeline_day28_desc: '340€ de dépenses de santé enregistrées pour les impôts. Aucune surprise à la déclaration.',
      timeline_day30_title: 'Mois clôturé : 180€ économisés',
      timeline_day30_desc: '12 jours de série budgétaire. Le coach suggère de renforcer le fonds d\'urgence.',
    }
  };
