(function () {
  ...
  var translations = {
    ...
    en: {
      ...
      timeline_day18_resolution: 'Today, Maria opens the app and sees a shopping list built with the products she planned for meals, with average prices the app stores based on data the user entered or consulted over time. Instead of guessing, she sees an estimated total for her purchase before leaving home. When building the list, Maria knows exactly how much each item usually costs and how it adds up to the expected purchase total. Going to the supermarket stops being a leap in the dark and becomes a conscious task: she sees the estimated impact on the budget and makes decisions at the cart with confidence, reducing stress and helping her stick to the financial plan she set at the beginning of the month.',
    ...
    es: {
      ...
      timeline_day14_pain: 'Ha pasado la mitad del mes y María ve que gran parte del presupuesto se fue en restaurantes. Eso trae culpa, inseguridad y esa sensación de \'no alcanza\'. En términos de comportamiento, esto es común — el estrés puede llevar a decisiones de gasto impulsivas cuando no hay estructura.',
      ...
      timeline_day18_pain: 'Antes, María entraba al supermercado sin saber exactamente cuánto iba a gastar — y eso generaba ansiedad, miedo de superar el presupuesto y decisiones impulsivas en el carrito. Estudios muestran que una lista bien planificada ayuda a reducir gasto y desperdicio simplemente al enfocar la compra en lo realmente necesario.',
      timeline_day18_resolution: 'Hoy, María abre la app y ve una lista de compras construida con los productos que planificó para las comidas, con los precios medios que la app guarda. En vez de adivinar, ve un valor estimado total para su compra antes de salir de casa. Al construir la lista, sabe exactamente cuánto suele valer cada artículo y cómo suma al total previsto. Ir al supermercado deja de ser un salto al vacío y pasa a ser una tarea consciente: ve el impacto estimado en el presupuesto y toma decisiones en el carrito con confianza, reduciendo estrés y ayudándola a mantener el plan financiero que definió al inicio del mes.',
    ...
    fr: {
      ...
      timeline_day14_pain: 'La moitié du mois est passée et Maria voit qu\'une grande partie du budget est partie en restaurants. Cela apporte culpabilité, insécurité et cette sensation que « ça ne suffit pas ». Sur le plan comportemental, c\'est courant — le stress peut mener à des décisions de dépenses impulsives quand il n\'y a pas de structure.',
      ...
      timeline_day18_pain: 'Avant, Maria entrait au supermarché sans savoir exactement combien elle allait dépenser — et cela générait de l\'anxiété, la peur de dépasser le budget et des décisions impulsives dans le chariot. Des études montrent qu\'une liste bien planifiée aide à réduire les dépenses et le gaspillage simplement en concentrant l\'achat sur ce qui est vraiment nécessaire.',
      timeline_day18_resolution: 'Aujourd\'hui, Maria ouvre l\'app et voit une liste de courses construite avec les produits qu\'elle a planifiés pour les repas, avec les prix moyens que l\'app conserve. Au lieu de deviner, elle voit un total estimé pour ses courses avant de quitter la maison. En construisant la liste, elle sait exactement combien coûte habituellement chaque article et comment cela s\'additionne au total prévu. Aller au supermarché n\'est plus un saut dans l\'inconnu mais une tâche consciente : elle voit l\'impact estimé sur le budget et prend des décisions dans le chariot avec confiance, réduisant le stress et l\'aidant à maintenir le plan financier qu\'elle a défini en début de mois.',
