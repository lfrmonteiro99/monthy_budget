    ...
    <LegalLayout>
      ...
      >
        ...
        <ol className="list-decimal pl-5 space-y-1.5 text-sm" style={{ color: "var(--text-secondary)" }}>
          ...
          <li><a href="#tu-3" className="no-underline hover:underline" style={{ color: "var(--text-secondary)" }}>Elegibilidade</a></li>
          <li><a href="#tu-4" className="no-underline hover:underline" style={{ color: "var(--text-secondary)" }}>Conta de Utilizador</a></li>
          <li><a href="#tu-5" className="no-underline hover:underline" style={{ color: "var(--text-secondary)" }}>Utilização Permitida</a></li>
          <li><a href="#tu-6" className="no-underline hover:underline" style={{ color: "var(--text-secondary)" }}>Dados Financeiros e Isenção de Responsabilidade</a></li>
          <li><a href="#tu-7" className="no-underline hover:underline" style={{ color: "var(--text-secondary)" }}>Propriedade Intelectual</a></li>
          <li><a href="#tu-8" className="no-underline hover:underline" style={{ color: "var(--text-secondary)" }}>Conteúdo do Utilizador</a></li>
          <li><a href="#tu-9" className="no-underline hover:underline" style={{ color: "var(--text-secondary)" }}>Disponibilidade do Serviço</a></li>
          <li><a href="#tu-10" className="no-underline hover:underline" style={{ color: "var(--text-secondary)" }}>Limitação de Responsabilidade</a></li>
          <li><a href="#tu-11" className="no-underline hover:underline" style={{ color: "var(--text-secondary)" }}>Atualizações e Modificações</a></li>
          <li><a href="#tu-12" className="no-underline hover:underline" style={{ color: "var(--text-secondary)" }}>Rescisão</a></li>
          <li><a href="#tu-13" className="no-underline hover:underline" style={{ color: "var(--text-secondary)" }}>Lei Aplicável e Resolução de Litígios</a></li>
          <li><a href="#tu-14" className="no-underline hover:underline" style={{ color: "var(--text-secondary)" }}>Disposições Gerais</a></li>
          <li><a href="#tu-15" className="no-underline hover:underline" style={{ color: "var(--text-secondary)" }}>Contacto</a></li>
        </ol>
      </nav>
      ...
      <div className="legal-body space-y-4 text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
        ...
        <h2 id="tu-3" className="text-xl font-bold mt-8 mb-3" style={{ color: "var(--text-primary)" }}>3. Elegibilidade</h2>
        ...
        <h2 id="tu-4" className="text-xl font-bold mt-8 mb-3" style={{ color: "var(--text-primary)" }}>4. Conta de Utilizador</h2>
        <h3 className="text-base font-semibold mt-6 mb-2" style={{ color: "var(--text-primary)" }}>4.1 Criação de conta</h3>
        ...
        <h3 className="text-base font-semibold mt-6 mb-2" style={{ color: "var(--text-primary)" }}>4.2 Responsabilidade pela conta</h3>
        ...
        <h3 className="text-base font-semibold mt-6 mb-2" style={{ color: "var(--text-primary)" }}>4.3 Eliminação da conta</h3>
        ...
        <h2 id="tu-5" className="text-xl font-bold mt-8 mb-3" style={{ color: "var(--text-primary)" }}>5. Utilização Permitida</h2>
        ...
        <h2 id="tu-6" className="text-xl font-bold mt-8 mb-3" style={{ color: "var(--text-primary)" }}>6. Dados Financeiros e Isenção de Responsabilidade</h2>
        <h3 className="text-base font-semibold mt-6 mb-2" style={{ color: "var(--text-primary)" }}>6.1 Caráter informativo</h3>
        ...
        <h3 className="text-base font-semibold mt-6 mb-2" style={{ color: "var(--text-primary)" }}>6.2 Tabelas de IRS</h3>
        ...
        <h3 className="text-base font-semibold mt-6 mb-2" style={{ color: "var(--text-primary)" }}>6.3 Coach financeiro com IA</h3>
        ...
        <h3 className="text-base font-semibold mt-6 mb-2" style={{ color: "var(--text-primary)" }}>6.4 Preços de supermercado</h3>
        ...
        <h2 id="tu-7" className="text-xl font-bold mt-8 mb-3" style={{ color: "var(--text-primary)" }}>7. Propriedade Intelectual</h2>
        ...
        <h2 id="tu-8" className="text-xl font-bold mt-8 mb-3" style={{ color: "var(--text-primary)" }}>8. Conteúdo do Utilizador</h2>
        ...
        <h2 id="tu-9" className="text-xl font-bold mt-8 mb-3" style={{ color: "var(--text-primary)" }}>9. Disponibilidade do Serviço</h2>
        <ul className="list-disc pl-6 space-y-1.5">
        ...
        <h2 id="tu-10" className="text-xl font-bold mt-8 mb-3" style={{ color: "var(--text-primary)" }}>10. Limitação de Responsabilidade</h2>
        ...
        <h2 id="tu-11" className="text-xl font-bold mt-8 mb-3" style={{ color: "var(--text-primary)" }}>11. Atualizações e Modificações</h2>
        <ul className="list-disc pl-6 space-y-1.5">
        ...
        <h2 id="tu-12" className="text-xl font-bold mt-8 mb-3" style={{ color: "var(--text-primary)" }}>12. Rescisão</h2>
        ...
        <h2 id="tu-13" className="text-xl font-bold mt-8 mb-3" style={{ color: "var(--text-primary)" }}>13. Lei Aplicável e Resolução de Litígios</h2>
        ...
        <h2 id="tu-14" className="text-xl font-bold mt-8 mb-3" style={{ color: "var(--text-primary)" }}>14. Disposições Gerais</h2>
        <ul className="list-disc pl-6 space-y-1.5">
        ...
        <h2 id="tu-15" className="text-xl font-bold mt-8 mb-3" style={{ color: "var(--text-primary)" }}>15. Contacto</h2>
