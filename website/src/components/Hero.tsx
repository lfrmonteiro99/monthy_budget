...
export default function Hero() {
  ...
  return (
    <>
      <section className="pt-20 pb-16 text-center relative overflow-hidden" id="main-content" tabIndex={-1}>
        ...
        <div className="max-w-[1140px] mx-auto px-6 relative">
          ...
          <motion.p
            ...
            className="text-lg max-w-xl mx-auto mb-9 leading-relaxed"
          ...
          >
            <a
              href="#download"
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-semibold text-sm text-white no-underline hover:no-underline transition-all hover:-translate-y-0.5"
              style={{
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-semibold text-sm no-underline hover:no-underline transition-all hover:-translate-y-0.5 border"
              style={{
          ...
          >
            {[
              ...
              <div key={stat.label} className="flex items-center">
                {i > 0 && <div className="w-px h-8 mx-0" style={{ background: "var(--border)" }} />}
                <div className="flex flex-col items-center px-8">
                  <span className="text-2xl font-bold" style={{ color: "var(--primary-val)" }}>{stat.value}</span>
