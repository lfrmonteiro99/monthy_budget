...
export const translations: Record<Locale, TranslationKeys> = {
  pt: {
    ...
    hero_subtitle: "Junta-te às famílias portuguesas que já controlam o IRS, as compras do supermercado e cada cêntimo do mês — sem folhas de Excel, sem apps complicadas. Gratuita para sempre.",
    ...
    trust2: "Zero anúncios. Zero custos. Para sempre.",
    ...
    how_step1_desc: "Grátis na Google Play. Sem registo obrigatório, sem cartão de crédito, sem truques.",
    ...
    feat2_title: "IRS Português Calculado em Segundos",
    feat2_desc: "Introduz o teu salário bruto e, em 2 segundos, vês o líquido exato que cai na conta — com tabelas de IRS 2026 integradas, taxa efetiva e deduções. Nunca mais abres aquele simulador duvidoso que te dá um número diferente de cada vez.",
    ...
    cta_desc: "Junta-te às famílias portuguesas que deixaram de sobreviver ao mês e começaram a dominá-lo. Grátis. Sem anúncios. Sem dados enviados para lado nenhum. Só tu e o teu dinheiro — finalmente em paz.",
    cta_button: "Descarregar Grátis na Google Play",
    cta_micro: "Leva menos de 5 minutos a configurar. O teu próximo mês agradece.",
    footer_desc: "A app gratuita que está a mudar a forma como as famílias portuguesas vivem o dinheiro. Feita em Portugal, com orgulho.",
    ...
    faq1_q: "A app é mesmo 100% grátis?",
    faq1_a: "Sim. Sem versão premium, sem compras dentro da app, sem período de experiência. Grátis para sempre.",
  ...
  en: {
    ...
    hero_subtitle: "Join the families already controlling their taxes, groceries and every cent of the month — no spreadsheets, no complicated apps. Free forever.",
    ...
    trust2: "Zero ads. Zero cost. Forever.",
    ...
    how_step1_desc: "Free on Google Play. No sign-up required, no credit card, no tricks.",
    ...
    feat2_title: "Portuguese Tax Calculated in Seconds",
    feat2_desc: "Enter your gross salary and, in 2 seconds, see the exact net amount that hits your account — with 2026 IRS tax tables built in, effective rate and deductions. Never open that dodgy simulator that gives you a different number every time.",
    ...
    cta_desc: "Join the families who stopped surviving the month and started owning it. Free. No ads. No data sent anywhere. Just you and your money — finally at peace.",
    cta_button: "Download Free on Google Play",
    cta_micro: "Takes less than 5 minutes to set up. Your next month will thank you.",
    footer_desc: "The free app changing how families experience money. Made in Portugal, with pride.",
    footer_app_heading: "App",
    footer_legal_heading: "Legal",
    ...
    faq1_q: "Is the app really 100% free?",
    faq1_a: "Yes. No premium version, no in-app purchases, no trial period. Free forever.",
  ...
  es: {
    ...
    hero_subtitle: "Únete a las familias que ya controlan sus impuestos, las compras del supermercado y cada céntimo del mes — sin hojas de Excel, sin apps complicadas. Gratis para siempre.",
    ...
    trust2: "Cero anuncios. Cero costes. Para siempre.",
    ...
    how_step1_desc: "Gratis en Google Play. Sin registro obligatorio, sin tarjeta de crédito, sin trucos.",
    ...
    feat2_title: "Impuestos Portugueses Calculados en Segundos",
    feat2_desc: "Introduce tu salario bruto y, en 2 segundos, ves el neto exacto que llega a tu cuenta — con tablas IRS 2026 integradas, tasa efectiva y deducciones. Nunca más abras ese simulador dudoso que te da un número diferente cada vez.",
    ...
    cta_desc: "Únete a las familias que dejaron de sobrevivir al mes y empezaron a dominarlo. Gratis. Sin anuncios. Sin datos enviados a ningún sitio. Solo tú y tu dinero — por fin en paz.",
    cta_button: "Descargar Gratis en Google Play",
    cta_micro: "Lleva menos de 5 minutos configurar. Tu próximo mes te lo agradecerá.",
    footer_desc: "La app gratuita que está cambiando cómo las familias viven el dinero. Hecha en Portugal, con orgullo.",
    footer_app_heading: "App",
    footer_legal_heading: "Legal",
    footer_feat_link: "Funcionalidades",
    ...
    faq1_q: "¿La app es realmente 100% gratis?",
    faq1_a: "Sí. Sin versión premium, sin compras dentro de la app, sin período de prueba. Gratis para siempre.",
  ...
  fr: {
    ...
    hero_subtitle: "Rejoignez les familles qui contrôlent déjà leurs impôts, leurs courses et chaque centime du mois — sans tableurs, sans apps compliquées. Gratuite pour toujours.",
    ...
    trust2: "Zéro pub. Zéro coût. Pour toujours.",
    ...
    how_step1_desc: "Gratuite sur Google Play. Sans inscription obligatoire, sans carte de crédit, sans piège.",
    ...
    feat2_title: "Impôts Portugais Calculés en Secondes",
    feat2_desc: "Entrez votre salaire brut et, en 2 secondes, voyez le net exact qui arrive sur votre compte — avec les tables IRS 2026 intégrées, taux effectif et déductions. Plus jamais ouvrir ce simulateur douteux qui donne un chiffre différent à chaque fois.",
    ...
    cta_desc: "Rejoignez les familles qui ont arrêté de survivre au mois et ont commencé à le maîtriser. Gratuite. Sans pubs. Sans données envoyées nulle part. Juste vous et votre argent — enfin en paix.",
    cta_button: "Télécharger Gratuitement",
    cta_micro: "Moins de 5 minutes pour tout configurer. Votre prochain mois vous remerciera.",
    footer_desc: "L\u2019app gratuite qui change la façon dont les familles vivent l\u2019argent. Faite au Portugal, avec fierté.",
    footer_app_heading: "App",
    ...
    faq1_q: "L\u2019app est vraiment 100% gratuite ?",
    faq1_a: "Oui. Pas de version premium, pas d\u2019achats intégrés, pas de période d\u2019essai. Gratuite pour toujours.",
