...
export const translations: Record<Locale, TranslationKeys> = {
  pt: {
    ...
    faq1_a: "Sim, podes usar a app gratuitamente com funcionalidades essenciais. Ao instalar, tens acesso a tudo durante 14 dias para experimentares à vontade. Depois, decides se queres continuar grátis ou ativar um plano.",
    ...
    faq7_a: "Não. O teste de 14 dias é totalmente gratuito e não pede dados de pagamento. Só os introduzes se decidires subscrever um plano.",
    ...
    pricing_desc: "Começa com 14 dias grátis. Sem cartão de crédito. Cancela quando quiseres.",
    pricing_toggle_monthly: "Mensal",
    pricing_toggle_yearly: "Anual",
    pricing_save_badge: "Poupa 37%",
    pricing_trial_banner: "14 dias grátis em todos os planos",
    ...
    pricing_free_feat1: "Calculadora de orçamento (5 categorias)",
  ...
  en: {
    ...
    faq1_a: "Yes, you can use the app for free with essential features. When you install, you get full access to everything for 14 days. After that, you decide whether to stay free or activate a plan.",
    ...
    faq7_a: "No. The 14-day trial is completely free and doesn\u2019t ask for payment details. You only enter them if you decide to subscribe.",
    ...
    pricing_desc: "Start with 14 days free. No credit card. Cancel anytime.",
    pricing_toggle_monthly: "Monthly",
    pricing_toggle_yearly: "Yearly",
    pricing_save_badge: "Save 37%",
    pricing_trial_banner: "14 days free on all plans",
    ...
    pricing_free_feat1: "Budget calculator (5 categories)",
  ...
  es: {
    ...
    faq1_a: "Sí, puedes usar la app gratis con funcionalidades esenciales. Al instalarla, tienes acceso completo durante 14 días para probar todo. Después, decides si continúas gratis o activas un plan.",
    ...
    faq7_a: "No. La prueba de 14 días es totalmente gratuita y no pide datos de pago. Solo los introduces si decides suscribirte.",
    ...
    pricing_desc: "Empieza con 14 días gratis. Sin tarjeta de crédito. Cancela cuando quieras.",
    pricing_toggle_monthly: "Mensual",
    pricing_toggle_yearly: "Anual",
    pricing_save_badge: "Ahorra 37%",
    pricing_trial_banner: "14 días gratis en todos los planes",
    pricing_free_name: "Gratuito",
    pricing_free_price: "€0",
    ...
    pricing_free_feat1: "Calculadora de presupuesto (5 categorías)",
  ...
  fr: {
    ...
    faq1_a: "Oui, vous pouvez utiliser l\u2019app gratuitement avec les fonctionnalités essentielles. À l\u2019installation, vous avez accès à tout pendant 14 jours. Ensuite, vous décidez de rester en gratuit ou d\u2019activer un plan.",
    ...
    faq7_a: "Non. L\u2019essai de 14 jours est entièrement gratuit et ne demande aucune information de paiement. Vous ne les saisissez que si vous décidez de vous abonner.",
    ...
    pricing_desc: "Commencez avec 14 jours gratuits. Sans carte de crédit. Annulez quand vous voulez.",
    pricing_toggle_monthly: "Mensuel",
    pricing_toggle_yearly: "Annuel",
    pricing_save_badge: "Économisez 37%",
    pricing_trial_banner: "14 jours gratuits sur tous les plans",
    ...
    pricing_free_feat1: "Calculateur de budget (5 catégories)",
